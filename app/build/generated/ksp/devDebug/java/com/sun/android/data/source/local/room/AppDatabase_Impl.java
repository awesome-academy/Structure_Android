  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `movies` (`id` INTEGER NOT NULL, `backDropImage` TEXT NOT NULL, `overView` TEXT NOT NULL, `vote` REAL NOT NULL, `voteCount` INTEGER NOT NULL, `title` TEXT NOT NULL, `urlImage` TEXT NOT NULL, `originalTitle` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '8340628348139ffac733e80c9533ee2e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsMovies.put("backDropImage", new TableInfo.Column("backDropImage", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovies.put("overView", new TableInfo.Column("overView", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovies.put("vote", new TableInfo.Column("vote", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsMovies.put("urlImage", new TableInfo.Column("urlImage", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoMovies.equals(_existingMovies)) {
          return new RoomOpenHelper.ValidationResult(false, "movies(com.sun.android.data.model.Movie).\n"
                  + " Expected:\n" + _infoMovies + "\n"
                  + " Found:\n" + _existingMovies);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "8340628348139ffac733e80c9533ee2e", "fc814f91d59b310dc5b58d9c67a711e7");
